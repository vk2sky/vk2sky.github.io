...
- [András Retzler HA7ILM's EOL Announcement for the original OpenWebRX](https://blog.sdr.hu/2019/12/29/openwebrx-eol.html)
- [András' Original OpenWebRX GitHub repository](https://github.com/ha7ilm/openwebrx)
- [Jakob Ketterl DD5JFK's OpenWebRX GitHub Repository](https://www.openwebrx.de/)
- [Marat Fayzullin KC1TXE's OpenWebRX+ GitHub Repository](https://fms.komkon.org/OWRX/)
- [John Seamons ZL4VO/KF6VO's KiwiSDR site](http://kiwisdr.com/) and [GitHub Repository](https://github.com/jks-prv/KiwiSDR)
- [The Manly-Warringah Radio Society](https://www.mwrs.org.au), my ham radio club in Sydney, Australia
...
- [Official RTL-SDR Store](https://www.rtl-sdr.com/buy-rtl-sdr-dvb-t-dongles/)
- [sn0ren on YouTube](https://www.youtube.com/@sn0ren) and his [gentle introduction to the RTL-SDR](https://www.youtube.com/watch?v=pjoUpIlQEXk)
- [OpenSourceSDRLab 2025 Clifford Heath VK2CLF's Version R10+ HackRF One](https://opensourcesdrlab.com/products/clifford-r10-hackrf)
...
- [3D Print Your Own SMA Tool](https://makerworld.com/en/models/1045174#profileId-1030835)
- [Time Difference of Arrival (TDOA)](https://dl.cdn-anritsu.com/en-us/test-measurement/files/Application-Notes/Application-Note/11410-01009D.pdf), a feature available on the KiwSDR, and perhaps one day on OpenWebRX+?
- [KiwiSDR TDoA Direction Finding Now Freely Available for Public Use](https://www.rtl-sdr.com/kiwisdr-tdoa-direction-finding-now-freely-available-for-public-use/)
- [OpenWebRX+ Releases](https://github.com/luarvique/openwebrx/releases/)
- [Raspberry Pi Imager](https://www.raspberrypi.com/software/)
- [IP2Location™ ISO 3166-2 Subdivision Code](https://www.ip2location.com/free/iso3166-2) Know your country code for setting the Wi-Fi channels on your Pi correctly
- [Bitwarden](https://bitwarden.com/products/personal/) secure password manager
